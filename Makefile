...
bin/$(FLAVOUR_DIR)libope$(SOSUFFIX): $(LIBOPENMPT_OBJECTS) $(LIBOPENMPT_LIBS)
	$(INFO) [LD] $@
ifeq ($(NO_SHARED_LINKER_FLAG),1)
...
ifeq ($(SHARED_SONAME),1)
	$(SILENT)mv bin/$(FLAVOUR_DIR)libope$(SOSUFFIX) bin/$(FLAVOUR_DIR)$(LIBOPENMPT_SONAME)
	$(SILENT)ln -sf $(LIBOPENMPT_SONAME) bin/$(FLAVOUR_DIR)libope$(SOSUFFIX)
endif
