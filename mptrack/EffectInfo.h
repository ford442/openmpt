...
bool GetEffectName(CString &pszDescription, ModCommand::COMMAND command, UINT param,
                   bool bXX = false) const; // bXX: Nxx: ...
...
bool GetEffectInfo(UINT ndx, CString *s, bool bXX = false, ModCommand::PARAM *prangeMin = nullptr,
                   ModCommand::PARAM *prangeMax = nullptr) const;
...
// Get range information, effect name, etc... from a given effect.
bool
GetVolCmdInfo(UINT ndx, CString *s, ModCommand::VOL *prangeMin = nullptr, ModCommand::VOL *prangeMax = nullptr) const;
