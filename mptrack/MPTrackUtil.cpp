...
static bool CreateShellLink(const IID &type, const mpt::PathString &path, const mpt::PathString &target,
                            const mpt::ustring &description) {
HRESULT hres = 0;
...
bool
CreateShellFolderLink(const mpt::PathString &path, const mpt::PathString &target, const mpt::ustring &description) {
