...
{
switch(
MIDIEvents::GetTypeFromEvent(data)
)
{
...
default:
if(
::PostMessage(hWndMidi, WM_MOD_MIDIMSG, data, dwParam2
))
...
CMainFrame::GetInputHandler()->
HandleMIDIMessage(kCtxAllContexts, data
);
...
if(midiInOpen(&shMidiIn, TrackerSettings::Instance().GetCurrentMIDIDevice(), (DWORD_PTR)
MidiInCallBack, 0, CALLBACK_FUNCTION) != MMSYSERR_NOERROR)
{
shMidiIn = nullptr;
