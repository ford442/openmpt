...
static bool
Paste(CSoundFile &sndFile, PatternEditPos &pastePos, PasteModes mode, PatternRect &pasteRect, bool &orderChanged);
// Try pasting a pattern selection from an internal clipboard.
static bool Paste(CSoundFile &sndFile, PatternEditPos &pastePos, PasteModes mode, PatternRect &pasteRect,
...
static bool HandlePaste(CSoundFile &sndFile, PatternEditPos &pastePos, PasteModes mode, const std::string &data,
                        PatternRect &pasteRect, bool &orderChanged);
// System-specific clipboard functions
static bool ToSystemClipboard(const PatternClipboardElement &clipboard) {
return ToSystemClipboard(clipboard.content);
};
