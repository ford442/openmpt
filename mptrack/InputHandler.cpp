...
CommandID CInputHandler::KeyEvent(InputTargetContext context, UINT &nChar, UINT &/*nRepCnt*/, UINT &nFlags,
                                  KeyEventType keyEventType, CWnd *pSourceWnd) {
...
break;
case VK_LWIN:
case VK_RWIN: // Feature: use Windows keys as modifier keys
...
static constexpr std::tuple<UINT, CommandID, const TCHAR *>
MenuItems[] =
        {
                ...
                {ID_FILE_SAVEASWAVE,            kcFileSaveAsWave,            _T(
                        "Stream Export (&WAV, FLAC, MP3, etc.)...")},
