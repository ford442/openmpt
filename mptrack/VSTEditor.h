...
LRESULT OnPreTranslateKeyDown(WPARAM wParam, LPARAM lParam) {
return HandlePreTranslateMessage(WM_KEYDOWN, wParam, lParam);
}
LRESULT OnPreTranslateKeyUp(WPARAM wParam, LPARAM lParam) {
return HandlePreTranslateMessage(WM_KEYUP, wParam, lParam);
}
LRESULT OnPreTranslateSysKeyDown(WPARAM wParam, LPARAM lParam) {
return HandlePreTranslateMessage(WM_SYSKEYDOWN, wParam, lParam);
}
LRESULT OnPreTranslateSysKeyUp(WPARAM wParam, LPARAM lParam) {
return HandlePreTranslateMessage(WM_SYSKEYUP, wParam, lParam);
}
