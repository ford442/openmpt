...
constexpr std::tuple<InputTargetContext, CommandID, CommandID>
NoteContexts[] = {{
...
KeyCommand::KeyCommand(uint32
uid,
const TCHAR *message, std::vector<KeyCombination>
keys)
: kcList{
std::move(keys)
}
...
const TCHAR *description = nullptr;
} CommandDefinitions[] =
        {
                ...
                {KeyCommand::Hidden,        kcVPChordStopA_1,                         _T(
                        "Stop base octave +1 chord A")},
                {KeyCommand::Hidden,        kcVPChordStopAS1,                         _T(
                        "Stop base octave +1 chord A#")},
                {KeyCommand::Hidden,        kcVPChordStopB_1,                         _T(
                        "Stop base octave +1 chord B")},
                {KeyCommand::Hidden,        kcVPChordStopC_1,                         _T(
                        "Stop base octave +1 chord C")},
                {KeyCommand::Hidden,        kcVPChordStopCS1,                         _T(
                        "Stop base octave +1 chord C#")},
                {KeyCommand::Hidden,        kcVPChordStopD_1,                         _T(
                        "Stop base octave +1 chord D")},
                {KeyCommand::Hidden,        kcVPChordStopDS1,                         _T(
                        "Stop base octave +1 chord D#")},
                {KeyCommand::Hidden,        kcVPChordStopE_1,                         _T(
                        "Stop base octave +1 chord E")},
                {KeyCommand::Hidden,        kcVPChordStopF_1,                         _T(
                        "Stop base octave +1 chord F")},
                {KeyCommand::Hidden,        kcVPChordStopFS1,                         _T(
                        "Stop base octave +1 chord F#")},
                {KeyCommand::Hidden,        kcVPChordStopG_1,                         _T(
                        "Stop base octave +1 chord G")},
                {KeyCommand::Hidden,        kcVPChordStopGS1,                         _T(
                        "Stop base octave +1 chord G#")},
                {KeyCommand::Hidden,        kcVPChordStopA_2,                         _T(
                        "Stop base octave +2 chord A")},
                {KeyCommand::Hidden,        kcVPChordStopAS2,                         _T(
                        "Stop base octave +2 chord A#")},
                {KeyCommand::Hidden,        kcVPChordStopB_2,                         _T(
                        "Stop base octave +2 chord B")},
                {KeyCommand::Hidden,        kcVPChordStopC_2,                         _T(
                        "Stop base octave +2 chord C")},
                {KeyCommand::Hidden,        kcVPChordStopCS2,                         _T(
                        "Stop base octave +2 chord C#")},
                {KeyCommand::Hidden,        kcVPChordStopD_2,                         _T(
                        "Stop base octave +2 chord D")},
                {KeyCommand::Hidden,        kcVPChordStopDS2,                         _T(
                        "Stop base octave +2 chord D#")},
                {KeyCommand::Hidden,        kcVPChordStopE_2,                         _T(
                        "Stop base octave +2 chord E")},
                {KeyCommand::Hidden,        kcVPChordStopF_2,                         _T(
                        "Stop base octave +2 chord F")},
                {KeyCommand::Hidden,        kcVPChordStopFS2,                         _T(
                        "Stop base octave +2 chord F#")},
                {KeyCommand::Hidden,        kcVPChordStopG_2,                         _T(
                        "Stop base octave +2 chord G")},
                {KeyCommand::Hidden,        kcVPChordStopGS2,                         _T(
                        "Stop base octave +2 chord G#")},
                {KeyCommand::Hidden,        kcVPChordStopA_3,                         _T(
                        "Stop base octave +3 chord A")},
                ...
                {1234,                      kcSetVolumeVolSlideUp,                    _T(
                        "Volume Command - Volume Slide Up")},
                {1235,                      kcSetVolumeVolSlideDown,                  _T(
                        "Volume Command - Volume Slide Down")},
                {1236,                      kcSetVolumeFineVolUp,                     _T(
                        "Volume Command - Fine Volume Slide Up")},
                {1237,                      kcSetVolumeFineVolDown,                   _T(
                        "Volume Command - Fine Volume Slide Down")},
                {1238,                      kcSetVolumeVibratoSpd,                    _T(
                        "Volume Command - Vibrato Speed")},
                {1239,                      kcSetVolumeVibrato,                       _T(
                        "Volume Command - Vibrato Depth")},
                {1240,                      kcSetVolumeXMPanLeft,                     _T(
                        "Volume Command - XM Pan Slide Left")},
                {1241,                      kcSetVolumeXMPanRight,                    _T(
                        "Volume Command - XM Pan Slide Right")},
                {1242,                      kcSetVolumePortamento,                    _T(
                        "Volume Command - Tone Portamento")},
                {1243,                      kcSetVolumeITPortaUp,                     _T(
                        "Volume Command - Portamento Up")},
                {1244,                      kcSetVolumeITPortaDown,                   _T(
                        "Volume Command - Portamento Down")},
                ...
                {KeyCommand::Hidden,        kcSetFXportSlide,                         _T(
                        "FX Portamento + Volume Slide")},
                ...
                {1317 | KeyCommand::Dummy,  kcSetSpacing,                             _T(
                        "Set edit step on note entry")},
	...
	*/
                ...
                {1352 | KeyCommand::Hidden, kcFileSaveAsMP3,                          _T(
                        "File/Stream Export")}, // Legacy
	...
	*/
                ...
                {1377,                      kcDeleteWholeRow,                         _T(
                        "Delete Row(s) (All Channels)")},
                {1378,                      kcInsertRow,                              _T("Insert Row(s)")},
                {1379,                      kcInsertWholeRow,                         _T(
                        "Insert Row(s) (All Channels)")},
                {1380,                      kcSampleTrim,                             _T(
                ...
                {1665,                      kcClearFieldStepITStyle,                  _T(
                        "Clear field and step (IT Style)")},
                {1666,                      kcSetFXextension,                         _T(
                ...
                {KeyCommand::Hidden,        kcNavigateDownBySpacingSelect,            _T(
                        "kcNavigateDownBySpacingSelect")},
                {KeyCommand::Hidden,        kcNavigateUpBySpacingSelect,              _T(
                ...
                {1765,                      kcVSTGUIRandParams,                       _T(
                        "Randomize Plugin Parameters")},
                {1766,                      kcPatternGoto,                            _T("Go to row/channel/...")},
                {KeyCommand::Hidden,        kcPatternOpenRandomizer,                  _T(
                        "Pattern Randomizer")},  // while there's not randomizer yet, let's just disable it for now
                {1768,                      kcPatternInterpolateNote,                 _T("Interpolate Note")},
                {KeyCommand::Hidden,        kcViewGraph,                              _T(
                        "View Graph")},  // while there's no graph yet, let's just disable it for now
                {1770,                      kcToggleChanMuteOnPatTransition,          _T(
                        "(Un)mute channel on pattern transition")},
                {1771,                      kcChannelUnmuteAll,                       _T("Unmute all channels")},
                {1772,                      kcShowPatternProperties,                  _T("Show Pattern Properties")},
                {1773,                      kcShowMacroConfig,                        _T(
                        "View Zxx Macro Configuration")},
                ...
                {1778,                      kcUnmuteAllChnOnPatTransition,            _T(
                        "Unmute all channels on pattern transition")},
                {1779,                      kcSoloChnOnPatTransition,                 _T(
                        "Solo channel on pattern transition")},
                {1780,                      kcTimeAtRow,                              _T(
                        "Show playback time at current row")},
                {1781,                      kcViewMIDImapping,                        _T("View MIDI Mapping")},
                {1782,                      kcVSTGUIPrevPresetJump,                   _T(
                        "Plugin preset backward jump")},
                {1783,                      kcVSTGUINextPresetJump,                   _T("Plugin preset forward jump")},
                {1784,                      kcSampleInvert,                           _T("Invert Sample Phase")},
                {1785,                      kcSampleSignUnsign,                       _T(
                ...
                {KeyCommand::Hidden,        kcOrderlistNavigateLeftSelect,            _T(
                        "kcOrderlistNavigateLeftSelect")},
                {KeyCommand::Hidden,        kcOrderlistNavigateRightSelect,           _T(
                        "kcOrderlistNavigateRightSelect")},
                {KeyCommand::Hidden,        kcOrderlistNavigateFirstSelect,           _T(
                        "kcOrderlistNavigateFirstSelect")},
                {KeyCommand::Hidden,        kcOrderlistNavigateLastSelect,            _T(
                ...
                {1819,                      kcShowSplitKeyboardSettings,              _T(
                        "Split Keyboard Settings dialog")},
                {1820,                      kcEditPushForwardPaste,                   _T(
                ...
                {1825,                      kcInstrumentEnvelopePointPrev,            _T(
                ...
                {1834,                      kcInstrumentEnvelopePointMoveUp8,         _T(
                        "Move envelope point up (Coarse)")},
                {1835,                      kcInstrumentEnvelopePointMoveDown8,       _T(
                        "Move envelope point down (Coarse)")},
                {1836,                      kcPatternEditPCNotePlugin,                _T(
                        "Toggle PC Event/instrument plugin editor")},
                ...
                {1844,                      kcInsNoteMapTransposeOctDown,             _T(
                        "Transpose -1 Octave (Note Map)")},
                {1845,                      kcInsNoteMapTransposeOctUp,               _T(
                        "Transpose +1 Octave (Note Map)")},
                {1846,                      kcInsNoteMapCopyCurrentNote,              _T(
                        "Map all notes to selected note")},
                {1847,                      kcInsNoteMapCopyCurrentSample,            _T(
                ...
                {1884,                      kcChannelSplitRecordSelect,               _T(
                        "Channel Split Record Select")},
                ...
                {1889,                      kcSampleMonoLeft,                         _T(
                        "Convert to Mono (Left Channel)")},
                {1890,                      kcSampleMonoRight,                        _T(
                        "Convert to Mono (Right Channel)")},
                {1891,                      kcSampleMonoSplit,                        _T(
                        "Convert to Mono (Split Sample)")},
                ...
                {1895,                      kcToggleNoteOffRecordPC,                  _T(
                        "Toggle Note Off record (PC keyboard)")},
                {1896,                      kcToggleNoteOffRecordMIDI,                _T(
                        "Toggle Note Off record (MIDI)")},
                {1897,                      kcFindInstrument,                         _T(
                        "Pick up nearest instrument number")},
                {1898,                      kcPlaySongFromPattern,                    _T(
                        "Play Song from Pattern Start")},
                {1899,                      kcVSTGUIToggleRecordMIDIOut,              _T(
                        "Record MIDI Out to Pattern Editor")},
                {1900,                      kcToggleClipboardManager,                 _T("Toggle Clipboard Manager")},
                {1901,                      kcClipboardPrev,                          _T(
                        "Cycle to Previous Clipboard")},
                ...
                {1918,                      kcSampleCenterSustainStart,               _T(
                        "Center sustain loop start in view")},
                {1919,                      kcSampleCenterSustainEnd,                 _T(
                        "Center sustain loop end in view")},
                ...
                {1958,                      kcInstrumentEnvelopeSelectSustainStart,   _T(
                        "Select Envelope Sustain Start")},
                {1959,                      kcInstrumentEnvelopeSelectSustainEnd,     _T(
                        "Select Envelope Sustain End")},
                {1960,                      kcInstrumentEnvelopePointMoveLeftCoarse,  _T(
                        "Move envelope point left (Coarse)")},
                {1961,                      kcInstrumentEnvelopePointMoveRightCoarse, _T(
                        "Move envelope point right (Coarse)")},
                ...
                {1966,                      kcSwitchToInstrLibrary,                   _T(
                        "Switch To Instrument Library")},
                {1967,                      kcPatternSetInstrumentNotEmpty,           _T(
                        "Apply current instrument to existing only")},
                ...
                {1971,                      kcPrevEntryInColumn,                      _T(
                        "Jump to previous entry in column")},
                {1972,                      kcNextEntryInColumn,                      _T(
                        "Jump to next entry in column")},
                {1973,                      kcViewTempoSwing,                         _T(
                        "View Global Tempo Swing Settings")},
                ...
                {1978,                      kcInstrumentEnvelopeSwitchToPitch,        _T(
                        "Switch to Pitch / Filter Envelope")},
                ...
                {1984,                      kcInstrumentEnvelopeToggleSustain,        _T(
                        "Toggle Envelope Sustain Loop")},
                ...
                {1991,                      kcSampleResize,                           _T(
                        "Add Silence / Create Sample")},
                {1992,                      kcSampleGrid,                             _T("Configure Sample Grid")},
                {1993,                      kcLoseSelection,                          _T("Lose Selection")},
                {1994,                      kcCutPatternChannel,                      _T(
                        "Cut to Pattern Channel Clipboard")},
                {1995,                      kcCutPattern,                             _T("Cut to Pattern Clipboard")},
                {1996,                      kcCopyPatternChannel,                     _T(
                        "Copy to Pattern Channel Clipboard")},
                {1997,                      kcCopyPattern,                            _T("Copy to Pattern Clipboard")},
                {1998,                      kcPastePatternChannel,                    _T(
                        "Paste from Pattern Channel Clipboard")},
                {1999,                      kcPastePattern,                           _T(
                        "Paste from Pattern Clipboard")},
                ...
                {2003,                      kcDeleteWholeRowGlobal,                   _T(
                        "Delete Row(s) (All Channels, Global)")},
                {2004,                      kcInsertRowGlobal,                        _T("Insert Row(s) (Global)")},
                {2005,                      kcInsertWholeRowGlobal,                   _T(
                        "Insert Row(s) (All Channels, Global)")},
                {2006,                      kcPrevSequence,                           _T("Previous Sequence")},
                {2007,                      kcNextSequence,                           _T("Next Sequence")},
                {2008,                      kcChnColorFromPrev,                       _T(
                        "Pick Color from Previous Channel")},
                {2009,                      kcChnColorFromNext,                       _T(
                        "Pick Color from Next Channel")},
                {2010,                      kcChannelMoveLeft,                        _T("Move Channels to Left")},
                {2011,                      kcChannelMoveRight,                       _T("Move Channels to Right")},
                {2012,                      kcSampleConvertPingPongLoop,              _T(
                        "Convert Ping-Pong Loop to Unidirectional")},
                {2013,                      kcSampleConvertPingPongSustain,           _T(
                        "Convert Ping-Pong Sustain Loop to Unidirectional")},
...
report += _T("The following commands may conflict:\r\n   >") + GetCommandText(conflictCmd.first) + _T(" in ") +
          conflictCmd.second.GetContextText() + _T("\r\n   >") + GetCommandText(cmd) + _T(" in ") +
          kc.GetContextText() + _T("\r\n\r\n");
...
std::pair <CommandID, KeyCombination>
CCommandSet::IsConflicting(KeyCombination kc, CommandID cmd, bool checkEventConflict) const {
...
if(inCmd >= kcStartPatNavigation && inCmd <= kcEndPatNavigation) {//Check that it is a nav cmd
CommandID cmdNavSelection = (CommandID) (kcStartPatNavigationSelect + (inCmd - kcStartPatNavigation));
for(auto &kc :m_commands[kcSelect].kcList) {//for all selection modifiers
newKc = inKc;
newKc.Modifier(kc);    //Add selection modifier's modifiers to this command
if(adding) {
LOG_COMMANDSET(
        MPT_UFORMAT("Enforcing rule krAllowNavigationWithSelection - adding key with modifier:{} to command: {}")(
                newKc.Modifier().GetRaw(), cmdNavSelection));
Add(newKc, cmdNavSelection, false);
} else {
LOG_COMMANDSET(
        MPT_UFORMAT("Enforcing rule krAllowNavigationWithSelection - removing key with modifier:{} to command: {}")(
                newKc.Modifier().GetRaw(), cmdNavSelection));
...
else if(inCmd >= kcStartOrderlistNavigation && inCmd <= kcEndOrderlistNavigation) {//Check that it is a nav cmd
...
LOG_COMMANDSET(
        MPT_UFORMAT("Enforcing rule krAllowNavigationWithSelection - adding key:{} with modifier:{} to command: {}")(
                curCmd, inKc.Modifier().GetRaw(), cmdNavSelection));
Add(newKc, cmdNavSelection, false);
} else {
LOG_COMMANDSET(
        MPT_UFORMAT("Enforcing rule krAllowNavigationWithSelection - removing key:{} with modifier:{} to command: {}")(
...
for(auto &kc : m_commands[curCmd].kcList) {// for all keys for this command
...
if(inCmd >= kcStartPatNavigation && inCmd <= kcEndPatNavigation) {//if this is a navigation command
for(auto &kc : m_commands[kcSelect].kcList) {//for all deselection modifiers
newKcSel = kc;                // get all properties from the selection key
newKcSel.AddModifier(inKc);    // add modifiers from the new nav command
if(adding) {
LOG_COMMANDSET(
        U_("Enforcing rule krAllowSelectionWithNavigation: adding  removing kcSelectWithNav and kcSelectOffWithNav"));
...
if(inCmd >= kcStartOrderlistNavigation && inCmd <= kcEndOrderlistNavigation) {//if this is a navigation command
for(auto &kc : m_commands[kcSelect].kcList) {//for all deselection modifiers
newKcSel = kc;                // get all properties from the selection key
newKcSel.AddModifier(inKc);    // add modifiers from the new nav command
if(adding) {
...
for(int curCmd = kcStartPatNavigation; curCmd <= kcEndPatNavigation; curCmd++) {//for all nav commands
for(auto &kc : m_commands[curCmd].kcList) {// for all keys for this command
newKcSel = inKc;            // get all properties from the selection key
newKcSel.AddModifier(kc);    //add the nav keys' modifiers
if(adding) {
LOG_COMMANDSET(
        MPT_UFORMAT("Enforcing rule krAllowSelectionWithNavigation - adding key:{} with modifier:{} to command: {}")(
                curCmd, inKc.Modifier().GetRaw(), kcSelectWithNav));
Add(newKcSel, kcSelectWithNav, false);
} else {
LOG_COMMANDSET(
        MPT_UFORMAT("Enforcing rule krAllowSelectionWithNavigation - removing key:{} with modifier:{} to command: {}")(
                curCmd, inKc.Modifier().GetRaw(), kcSelectWithNav));
Remove(newKcSel, kcSelectWithNav);
}
}
...
cmdOff = kcSelectOffWithNav;
break;
case kcCopySelect:
cmdOff = kcCopySelectOff;
break;
case kcCopySelectWithNav:
cmdOff = kcCopySelectOffWithNav;
break;
case kcSelectWithCopySelect:
cmdOff = kcSelectOffWithCopySelect;
break;
case kcCopySelectWithSelect:
cmdOff = kcCopySelectOffWithSelect;
break;
}
if(cmdOff != kcNull) {
newKcDeSel = inKc;
...
const UINT maxMod = TrackerSettings::Instance().MiscDistinguishModifiers ? MaxMod : (MaxMod & ~(HOTKEYF_RSHIFT |
                                                                                                HOTKEYF_RCONTROL |
                                                                                                HOTKEYF_RALT));
...
for(auto &kc : m_commands[kcChordModifier].kcList) {//for all chord modifier keys
newKc = inKc;
...
int noteOffset;
for(int curCmd = kcVPStartNotes; curCmd <= kcVPEndNotes; curCmd++) {//for all notes
for(auto kc : m_commands[curCmd].kcList) {//for all keys for this note
...
if((inKc.Modifier() == ModNone) &&    //no modifier
   ...
   (('0' <= inKc.KeyCode() && inKc.KeyCode() <= '9') ||
    (VK_NUMPAD0 <= inKc.KeyCode() && inKc.KeyCode() <= VK_NUMPAD9)))  //is number key
{
...
for(auto &kc : m_commands[curCmd].kcList) {
if((!kc.Modifier()) ||
   (kc.KeyCode() != VK_SHIFT && kc.KeyCode() != VK_CONTROL && kc.KeyCode() != VK_MENU && kc.KeyCode() != 0 &&
    kc.KeyCode() != VK_LWIN && kc.KeyCode() != VK_RWIN)) // Feature: use Windows keys as modifier keys
{
report += _T("Error! ") + GetCommandText((CommandID) curCmd) +
          _T(" must be a modifier (shift/ctrl/alt), but is currently ") + inKc.GetKeyText() + _T("\r\n");
//replace with dummy
...
contexts.insert(contexts.end(), {kCtxViewPatternsNote, kCtxViewPatternsIns, kCtxViewPatternsVol, kCtxViewPatternsFX,
...
mpt::SafeOutputFile sf(filename, std::ios::out,
...
return mpt::make_basic_string(mpt::byte_cast<mpt::span<const char>>(
        GetResource(MAKEINTRESOURCE(IDR_DEFAULT_KEYBINDINGS), TEXT("KEYBINDINGS"))));
}
...
errText.AppendFormat(
        _T("File version is %d, but your version of OpenMPT only supports loading files up to version %d.\n"),
...
static constexpr std::pair<CommandID, CommandID>
MergeCommands[] =
        {
...
m_commands[to].kcList.insert(m_commands[to].kcList.end(), m_commands[from].kcList.begin(),
                             m_commands[from].kcList.end());
m_commands[from].kcList.clear();
}
if(!errText.IsEmpty()) {
Reporting::Warning(
        MPT_CFORMAT("The following problems have been encountered while trying to load the key binding file {}:\n{}")
...
if(fin.fail()) {
Reporting::Warning(
        MPT_TFORMAT("Can't open key bindings file {} for reading. Default key bindings will be used.")(filename));
return false;
} else {
...
CommandID CCommandSet::FindCmd(uint32
uid) const
{
for(
int i = 0;
...
switch (ctx) {
case kCtxAllContexts:
return _T("Global Context");
case kCtxViewGeneral:
return _T("General Context [bottom]");
case kCtxViewPatterns:
return _T("Pattern Context [bottom]");
case kCtxViewPatternsNote:
return _T("Pattern Context [bottom] - Note Col");
case kCtxViewPatternsIns:
return _T("Pattern Context [bottom] - Ins Col");
case kCtxViewPatternsVol:
return _T("Pattern Context [bottom] - Vol Col");
case kCtxViewPatternsFX:
return _T("Pattern Context [bottom] - FX Col");
case kCtxViewPatternsFXparam:
return _T("Pattern Context [bottom] - Param Col");
case kCtxViewSamples:
return _T("Sample Context [bottom]");
case kCtxViewInstruments:
return _T("Instrument Context [bottom]");
case kCtxViewComments:
return _T("Comments Context [bottom]");
case kCtxCtrlGeneral:
return _T("General Context [top]");
case kCtxCtrlPatterns:
return _T("Pattern Context [top]");
case kCtxCtrlSamples:
return _T("Sample Context [top]");
case kCtxCtrlInstruments:
return _T("Instrument Context [top]");
case kCtxCtrlComments:
return _T("Comments Context [top]");
case kCtxCtrlOrderlist:
return _T("Orderlist");
case kCtxVSTGUI:
return _T("Plugin GUI Context");
case kCtxChannelSettings:
return _T("Quick Channel Settings Context");
case kCtxUnknownContext:
default:
return _T("Unknown Context");
}
}
