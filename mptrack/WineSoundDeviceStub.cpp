...
MPT_UNREFERENCED_PARAMETER(
        sysInfo); // we do not want to pass this to the native layer because it would actually be totally wrong
std::vector <SoundDevice::Info> result =
        json_cast < std::vector < SoundDevice::Info > > (WineWrapper->SoundDevice_EnumerateDevices());
...
static void
__cdecl SoundCallbackLockedProcessUint8Func(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
static void __cdecl SoundCallbackLockedProcessInt8Func(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
static void
__cdecl SoundCallbackLockedProcessInt16Func(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
static void
__cdecl SoundCallbackLockedProcessInt24Func(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
callback->SoundCallbackLockedProcess(bf, numFrames, static_cast<int24 *>(buffer),
                                     static_cast<const int24 *>(inputBuffer));
}
static void
__cdecl SoundCallbackLockedProcessInt32Func(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
static void
__cdecl SoundCallbackLockedProcessFloatFunc(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
static void
__cdecl SoundCallbackLockedProcessDoubleFunc(void *inst, const OpenMPT_SoundDevice_BufferFormat *bufferFormat,
...
SoundDevice::Info info = json_cast<SoundDevice::Info>(
        w->result_as_string(w->OpenMPT_Wine_Wrapper_SoundDevice_GetDeviceInfo(impl)));
info = AddTypePrefix(info);
return info;
}
...
return json_cast<SoundDevice::DynamicCaps>(w->result_as_string(
        w->OpenMPT_Wine_Wrapper_SoundDevice_GetDeviceDynamicCaps(impl,
                                                                 json_cast<std::string>(baseSampleRates).c_str())));
}
