...
StoredTags::StoredTags(SettingsContainer &conf)
        : artist(conf, U_("Export"), U_("TagArtist"), TrackerSettings::Instance().defaultArtist),
          album(conf, U_("Export"), U_("TagAlbum"), U_("")), trackno(conf, U_("Export"), U_("TagTrackNo"), U_("")),
          year(conf, U_("Export"), U_("TagYear"), GetDefaultYear()), url(conf, U_("Export"), U_("TagURL"), U_("")),
          genre(conf, U_("Export"), U_("TagGenre"), U_("")) {
return;
}
EncoderSettingsConf::EncoderSettingsConf(SettingsContainer &conf, const mpt::ustring &encoderName, bool cues, bool tags,
                                         uint32 samplerate, uint16 channels, Encoder::Mode mode, int bitrate,
                                         float quality, Encoder::Format format, int dither)
...
StreamEncoderSettingsConf::StreamEncoderSettingsConf(SettingsContainer &conf, const mpt::ustring &section)
        : FLACCompressionLevel(conf, section, U_("FLACCompressionLevel"),
                               Encoder::StreamSettings().FLACCompressionLevel),
          ...
          MP3ID3v2PaddingAlignHint(conf, section, U_("MP3ID3v2PaddingAlignHint"),
                                   Encoder::StreamSettings().MP3ID3v2PaddingAlignHint),
          MP3ID3v2WriteReplayGainTXXX(conf, section, U_("MP3ID3v2WriteReplayGainTXXX"),
                                      Encoder::StreamSettings().MP3ID3v2WriteReplayGainTXXX),
          ...
          MP3LameCalculateReplayGain(conf, section, U_("MP3LameCalculateReplayGain"),
                                     Encoder::StreamSettings().MP3LameCalculateReplayGain),
          MP3LameCalculatePeakSample(conf, section, U_("MP3LameCalculatePeakSample"),
                                     Encoder::StreamSettings().MP3LameCalculatePeakSample),
