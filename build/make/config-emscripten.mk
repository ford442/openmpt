...
CFLAGS   += -s DISABLE_EXCEPTION_CATCHING=1 -fno-strict-aliasing
LDFLAGS  += -s DISABLE_EXCEPTION_CATCHING=1 -s ERROR_ON_UNDEFINED_SYMBOLS=1 -s ERROR_ON_MISSING_LIBRARIES=1 -s EXPORT_NAME="'libopenmpt'"
