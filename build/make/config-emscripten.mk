...
CPPFLAGS += -fno-fast-math -ffp-contract=off -fexcess-precision=standard -mtune=wasm32 -fno-math-errno -mextended-const -mbulk-memory -matomics -mmutable-globals -msign-ext -fmerge-all-constants -fno-omit-frame-pointer
CXXFLAGS += -fno-fast-math -ffp-contract=off -fexcess-precision=standard -mtune=wasm32 -fno-math-errno -mextended-const -mbulk-memory -matomics -mmutable-globals -msign-ext -fmerge-all-constants -fno-omit-frame-pointer
CFLAGS   += -fno-fast-math -ffp-contract=off -fexcess-precision=standard -mtune=wasm32 -fno-math-errno -mextended-const -mbulk-memory -matomics -mmutable-globals -msign-ext -fmerge-all-constants -fno-omit-frame-pointer
LDFLAGS  += -DNDEBUG=1 \
