...
CPPFLAGS += -ffp-contract=off -fno-fast-math $(SIMD_FLAGS) 
CXXFLAGS += -ffp-contract=off -fno-fast-math $(SIMD_FLAGS) 
CFLAGS   += -ffp-contract=off -fno-fast-math
LDFLAGS  += $(LINK_SIMD_FLAGS) -DNDEBUG=1 -sASSERTIONS=0 -sEMULATE_FUNCTION_POINTER_CASTS=1 -sTRUSTED_TYPES=1 -pipe -dead-strip -fno-fast-math \
...
-sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=700mb -sALLOW_TABLE_GROWTH \
