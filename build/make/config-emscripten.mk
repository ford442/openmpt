...
LDFLAGS  += $(LINK_SIMD_FLAGS) -DNDEBUG=1 -sWASM_BIGINT=1 -sTRUSTED_TYPES=1 -pipe -dead-strip -fno-fast-math \
...
-sWASM=0 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=256mb -sALLOW_TABLE_GROWTH --closure 0 --closureFriendly \
--output_eol linux -sAUTO_ARCHIVE_INDEXES=0 -sALLOW_UNIMPLEMENTED_SYSCALLS=0 -sIGNORE_MISSING_MAIN=0 -sASSERTIONS=0
