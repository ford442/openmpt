...
CXXFLAGS += -ffp-contract=off -fno-fast-math -fno-strict-aliasing --use-port=mpg123 -DMPT_WITH_MPG123
CFLAGS   += -ffp-contract=off -fno-fast-math -fno-strict-aliasing --use-port=mpg123 -DMPT_WITH_MPG123
LDFLAGS  += --use-port=mpg123 -DMPT_WITH_MPG123 $(LINK_SIMD_FLAGS) -DNDEBUG=1 -sTRUSTED_TYPES=1 -pipe -dead-strip -fno-fast-math \
...
-march=haswell -rtlib=compiler-rt -sLEGALIZE_JS_FFI=1 -sENVIRONMENT=web -WASMFS=1 \
