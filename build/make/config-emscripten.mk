...
-mtune=wasm32 -polly -polly-position=before-vectorizer -ffp-contract=off -fexcess-precision=standard -stdlib=libc++ \
...
-march=haswell -rtlib=compiler-rt -sLEGALIZE_JS_FFI=1 -sENVIRONMENT=web -WASMFS=1 -sASYNCIFY=0 \
