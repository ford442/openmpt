...
# emits native wasm.
CPPFLAGS += -ffp-contract=off -fno-fast-math -mextended-const -mbulk-memory -matomics -mmutable-globals -mnontrapping-fptoint -msign-ext -fmerge-all-constants 
CXXFLAGS += -ffp-contract=off -fno-fast-math -mextended-const -mbulk-memory -matomics -mmutable-globals -mnontrapping-fptoint -msign-ext -fmerge-all-constants 
CFLAGS   += 
