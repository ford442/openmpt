 ...
 * \since 0.3.0
 */
LIBOPENMPT_API openmpt_module_ext *
 ...
 */
LIBOPENMPT_API int
openmpt_module_ext_get_interface(openmpt_module_ext *mod_ext, const char *interface_id, void *interface,
 ...
 */
int ( *get_pattern_row_channel_volume_effect_type )(openmpt_module_ext *mod_ext, int32_t pattern, int32_t row,
                                                    int32_t channel);
/*! Get pattern command type for pattern highlighting
 *
 * \param mod_ext The module handle to work on.
