...
MPT_BINARY_STRUCT(MTMFileHeader,
66)
// Sample Header
...
MPT_BINARY_STRUCT(MTMSampleHeader,
37)
...
return sizeof(MTMSampleHeader) * fileHeader.numSamples + 128 + 192 * fileHeader.numTracks +
       64 * (fileHeader.lastPattern + 1) + fileHeader.commentSize;
}
