...
MPT_BINARY_STRUCT(DSMSongHeader,
192)
...
MPT_BINARY_STRUCT(DSMSampleHeader,
64)
...
if(songHeader.numOrders > 128 || songHeader.numChannels > 16 || songHeader.numPatterns > 256 ||
