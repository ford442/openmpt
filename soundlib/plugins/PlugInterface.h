...
virtual void
MidiCommand(const ModInstrument &/*instr*/, uint16 /*note*/, uint16 /*vol*/, CHANNELINDEX /*trackChannel*/) {}
...
inline void IMixPlugin::ModifyParameter(PlugParamIndex
nIndex,
PlugParamValue diff
)
{
...
DecodePitchBendParam(int32
position) { return static_cast<int16>(position >> kPitchBendShift); }
