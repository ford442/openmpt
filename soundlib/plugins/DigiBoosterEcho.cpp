...
OPENMPT_NAMESPACE_BEGIN
        IMixPlugin
*
DigiBoosterEcho::Create(VSTPluginLib
&factory,
CSoundFile &sndFile, SNDMIXPLUGIN
*mixStruct)
{
return new (std::nothrow)
DigiBoosterEcho(factory, sndFile, mixStruct
);
}
DigiBoosterEcho::DigiBoosterEcho(VSTPluginLib &factory, CSoundFile &sndFile, SNDMIXPLUGIN *mixStruct)
        : IMixPlugin(factory, sndFile, mixStruct), m_sampleRate(sndFile.GetSampleRate()),
...
PlugParamValue DigiBoosterEcho::GetParameter(PlugParamIndex
index)
{
...
void DigiBoosterEcho::SetParameter(PlugParamIndex
index,
...
{
m_chunk.param[index] =
mpt::saturate_round<uint8>(value
* 255.0f);
RecalculateEchoParams();
}
}
