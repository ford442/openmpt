...
PlugParamValue I3DL2Reverb::GetParameter(PlugParamIndex
index) {
...
void I3DL2Reverb::SetParameter(PlugParamIndex
index,
...
float roomFilter = (freq * (roomHF + roomHF) - 2.0f + std::sqrt(
        freq * (roomHF * roomHF * freq * 4.0f) + roomHF * 8.0f - roomHF * roomHF * 4.0f - roomHF * freq * 8.0f)) /
                   (roomHF + roomHF - 2.0f);
