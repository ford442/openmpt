...
Echo::Echo(VSTPluginLib &factory, CSoundFile &sndFile, SNDMIXPLUGIN *mixStruct)
        : IMixPlugin(factory, sndFile, mixStruct), m_bufferSize(0), m_writePos(0),
          m_sampleRate(sndFile.GetSampleRate()), m_initialFeedback(0.0f) {
...
PlugParamValue Echo::GetParameter(PlugParamIndex
index) {
...
void Echo::SetParameter(PlugParamIndex
index,
