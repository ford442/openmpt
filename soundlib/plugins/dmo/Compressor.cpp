...
PlugParamValue Compressor::GetParameter(PlugParamIndex
index) {
...
void Compressor::SetParameter(PlugParamIndex
index,
...
m_threshold = std::min((_2e31 - 1.0f), (std::log(std::pow(10.0f, ThresholdInDecibel() / 20.0f) * _2e31) * _2e26) /
                                       mpt::numbers::ln2_v<float> + _2e26) * (1.0f / _2e31);
