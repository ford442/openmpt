...
MPT_BINARY_STRUCT(ITFileHeader,
192)
struct ITEnvelope {
// Envelope Flags
...
MPT_BINARY_STRUCT(ITEnvelope::Node,
3)
MPT_BINARY_STRUCT(ITEnvelope,
82)
...
MPT_BINARY_STRUCT(ITOldInstrument,
554)
...
MPT_BINARY_STRUCT(ITInstrument,
554)
...
MPT_BINARY_STRUCT(ITInstrumentEx,
sizeof(ITInstrument) + 120)
// IT Sample Format
struct ITSample {
// Magic Bytes
enum Magic {
...
public:
static constexpr int32
date = yy * 365 + yy / 4 - yy / 100 + yy / 400 + (mm * 306 + 5) / 10 + (d - 1);
};
inline constexpr int32
SchismTrackerEpoch = SchismVersionFromDate<2009, 10, 31>::date;
