...
MPT_BINARY_STRUCT(AsylumFileHeader,
38)
...
MPT_BINARY_STRUCT(AsylumSampleHeader,
37)
...
MPT_BINARY_STRUCT(AMFFileHeader,
41)
...
MPT_BINARY_STRUCT(AMFSampleHeaderOld,
59)
...
return type <= 1 && index <= numSamples && length <= 0x100000 && volume <= 64 && loopStart <= length &&
       loopEnd <= length;
}
};
MPT_BINARY_STRUCT(AMFSampleHeaderNew,
65)
