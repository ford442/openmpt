...
bufferSize = 2 + 0xFFFF;  // Our output buffer can't be longer than this.
static constexpr size_t
blockSize = 0x8000;       // Block size (in bytes) in which samples are being processed
...
template<typename Properties>
void CompressBlock(const typename Properties::sample_t *data, SmpLength offset, SmpLength actualLength,
