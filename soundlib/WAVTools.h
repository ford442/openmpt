...
MPT_BINARY_STRUCT(WAVFormatChunk,
16)
...
MPT_BINARY_STRUCT(WAVFormatChunkExtension,
24)
...
MPT_BINARY_STRUCT(WAVSampleInfoChunk,
36)
...
void
ApplyToSample(SmpLength &start, SmpLength &end, SmpLength sampleLength, SampleFlags &flags, ChannelFlags enableFlag,
              ChannelFlags bidiFlag, bool mptLoopFix) const;
// Convert internal loop information into a WAV loop.
void ConvertToWAV(SmpLength start, SmpLength end, bool bidi);
};
MPT_BINARY_STRUCT(WAVSampleLoop,
24)
...
MPT_BINARY_STRUCT(WAVInstrumentChunk,
7)
...
MPT_BINARY_STRUCT(WAVExtraChunk,
16)
...
WAVFormatChunk::SampleFormats GetSampleFormat() const {
return IsExtensibleFormat() ? static_cast<WAVFormatChunk::SampleFormats>(subFormat)
                            : static_cast<WAVFormatChunk::SampleFormats>(formatInfo.format.get());
}
