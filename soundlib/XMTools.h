...
MPT_BINARY_STRUCT(XMFileHeader,
80)
struct XMInstrument {
...
void ConvertEnvelopeToXM(const InstrumentEnvelope &mptEnv, uint8le &numPoints, uint8le &flags, uint8le &sustain,
                         uint8le &loopStart, uint8le &loopEnd, EnvType env);
void ConvertEnvelopeToMPT(InstrumentEnvelope &mptEnv, uint8 numPoints, uint8 flags, uint8 sustain, uint8 loopStart,
                          uint8 loopEnd, EnvType env) const;
...
MPT_BINARY_STRUCT(XMInstrument,
230)
...
MPT_BINARY_STRUCT(XMInstrumentHeader,
263)
...
MPT_BINARY_STRUCT(XIInstrumentHeader,
298)
struct XMSample {
enum XMSampleFlags {
sampleLoop = 0x01,
