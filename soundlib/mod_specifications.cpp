...
mptm_ =
        {
                ...
                SONG_LINEARSLIDES | SONG_EXFILTERRANGE | SONG_ITOLDEFFECTS |
                SONG_ITCOMPATGXX,    // Supported song flags
...
xmEx_ =
        {
                ...
                0,                                            // Max comment line length
                MAX_SAMPLES -
                1,                            // SamplesMax (actually 32 per instrument(256 * 32 = 8192), but limited to MAX_SAMPLES = 4000)
                255,                                        // instrumentMax
                MixLevels::CompatibleFT2,                    // defaultMixLevels
...
const std::array<const CModSpecifications *, 8> Collection = {&mptm_, &mod_, &s3m_, &s3mEx_, &xm_, &xmEx_, &it_,
                                                              &itEx_};
