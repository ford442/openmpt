...
MPT_BINARY_STRUCT(STPFileHeader,
204)
...
MPT_BINARY_STRUCT(STPSampleHeader,
20)
...
static TEMPO ConvertTempo(uint16
ciaSpeed)
{
...
for(SAMPLEINDEX smp = 1; smp <= samplesInFile; smp++)
