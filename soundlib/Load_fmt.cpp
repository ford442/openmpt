...
MPT_BINARY_STRUCT(FMTChannelSetting,
19)
...
MPT_BINARY_STRUCT(FMTFileHeader,
218)
...
m_modFormat.madeWithTracker = mpt::ToUnicode(mpt::Charset::CP437, mpt::String::ReadBuf(mpt::String::maybeNullTerminated,
