...
namespace Paula {
namespace {
MPT_NOINLINE std::vector<double>
KaiserFIR(int numTaps, double cutoff, double beta) {
...
output /= (1
        << (Paula::BLEP_SCALE - 2));    // - 2 to compensate for the fact that we reduced the input sample bit depth
