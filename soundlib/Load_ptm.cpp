...
MPT_BINARY_STRUCT(PTMFileHeader,
608)
...
MPT_BINARY_STRUCT(PTMSampleHeader,
80)
...
m_modFormat.madeWithTracker = MPT_UFORMAT("PolyTracker {}.{}")(fileHeader.versionHi.get(),
                                                               mpt::ufmt::hex0<2>(fileHeader.versionLo.get()));
...
effTrans[] = {CMD_GLOBALVOLUME, CMD_RETRIG, CMD_FINEVIBRATO, CMD_NOTESLIDEUP, CMD_NOTESLIDEDOWN, CMD_NOTESLIDEUPRETRIG,
              CMD_NOTESLIDEDOWNRETRIG, CMD_REVERSEOFFSET};
if(m.command < 0x10) {
