...
MPT_BINARY_STRUCT(GDMFileHeader,
157)
...
MPT_BINARY_STRUCT(GDMSampleHeader,
62)
static constexpr MODTYPE
gdmFormatOrigin[] =
{
...
static constexpr mpt::uchar
gdmFormatOriginType[][4] =
{
UL_(""), UL_("mod"), UL_("mtm"), UL_("s3m"), UL_("669"), UL_("far"), UL_("ult"), UL_("stm"), UL_("med"), UL_("psm")
};
static constexpr const mpt::uchar
* gdmFormatOriginFormat[] =
{
UL_(""),
UL_("Generic MOD"),
UL_("MultiTracker"),
...
rate2finetune[] = {8363, 8424, 8485, 8547, 8608, 8671, 8734, 8797, 7894, 7951, 8009, 8067, 8125, 8184, 8244, 8303};
