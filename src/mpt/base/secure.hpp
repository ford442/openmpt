...
namespace secure {
inline MPT_NOINLINE void memzero(std::byte *const dst, std::size_t const len)
noexcept {
...
inline MPT_NOINLINE void memzero(void *const dst, std::size_t const len)
noexcept {
std::atomic_thread_fence(std::memory_order_seq_cst);
volatile std::byte *volatile p = static_cast<volatile std::byte *>(dst);
std::atomic_thread_fence(std::memory_order_seq_cst);
...
inline MPT_NOINLINE void memzero(char *const dst, std::size_t const len)
noexcept {
std::atomic_thread_fence(std::memory_order_seq_cst);
...
inline MPT_NOINLINE void memzero(uint8 *const dst, std::size_t const len)
noexcept {
std::atomic_thread_fence(std::memory_order_seq_cst);
volatile std::byte *volatile p = reinterpret_cast<volatile std::byte *>(dst);
std::atomic_thread_fence(std::memory_order_seq_cst);
