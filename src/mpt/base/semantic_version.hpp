...
constexpr bool operator==(semantic_version const a, semantic_version const b)
noexcept {
return a.
as_tuple()
== b.
...
constexpr bool operator==(version_info const a, version_info const b)
noexcept {
return a.
as_tuple()
== b.
...
Version = {{MPT_VERSION_MAJOR, MPT_VERSION_MINOR, MPT_VERSION_PATCH}, MPT_VERSION_BUILD};
