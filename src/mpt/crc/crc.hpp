...
size_bytes = sizeof(value_type);
static constexpr std::size_t
size_bits = sizeof(value_type) * 8;
static constexpr value_type
top_bit = static_cast<value_type>(1) << ((sizeof(value_type) * 8) - 1);
private:
template<typename Tint>
static constexpr Tint
reverse(Tint
value) noexcept {
...
static constexpr value_type
calculate_table_entry(byte_type
pos) noexcept {
value_type value = 0;
...
private:
static constexpr std::array<value_type, 256>
calculate_table()
noexcept {
...
constexpr void processByte(byte_type byte)
noexcept {
