...
, Minor(
static_cast<uint32>((static_cast
<uint64>(number)
>> 0) & 0xffffffffu)) {
}
explicit constexpr System(uint64 number)
noexcept
...
explicit constexpr System(uint32 major, uint32 minor)
noexcept
        : Major(major)
, Minor(minor) {
}
...
uint16 Minor = 0;
ServicePack() = default;
explicit constexpr ServicePack(uint16 major, uint16 minor)
noexcept
        : Major(major)
, Minor(minor) {
}
constexpr bool HasServicePack() const
noexcept {
...
public:
static Version NoWindows()
noexcept {
return Version();
}
Version(mpt::osinfo::windows::Version::System system, mpt::osinfo::windows::Version::ServicePack servicePack,
        mpt::osinfo::windows::Version::Build build, mpt::osinfo::windows::Version::TypeId type)
noexcept
...
#endif // MPT_OS_WINDOWS
public:
static mpt::osinfo::windows::Version Current()
noexcept {
#if MPT_OS_WINDOWS
...
bool IsBefore(mpt::osinfo::windows::Version::System version) const
noexcept {
...
bool
IsBefore(mpt::osinfo::windows::Version::System version, mpt::osinfo::windows::Version::ServicePack servicePack) const
noexcept {
if(!m_SystemIsWindows) {
return false;
}
...
bool IsBefore(mpt::osinfo::windows::Version::System version, mpt::osinfo::windows::Version::Build build) const
noexcept {
if(!m_SystemIsWindows) {
return false;
}
...
bool IsBefore(mpt::osinfo::windows::Version::System version, mpt::osinfo::windows::Version::ServicePack servicePack,
              mpt::osinfo::windows::Version::Build build) const
noexcept {
if(!m_SystemIsWindows) {
return false;
}
...
bool IsAtLeast(mpt::osinfo::windows::Version::System version) const
noexcept {
if(!m_SystemIsWindows) {
return false;
}
...
bool
IsAtLeast(mpt::osinfo::windows::Version::System version, mpt::osinfo::windows::Version::ServicePack servicePack) const
noexcept {
if(!m_SystemIsWindows) {
return false;
}
...
bool IsAtLeast(mpt::osinfo::windows::Version::System version, mpt::osinfo::windows::Version::Build build) const
noexcept {
if(!m_SystemIsWindows) {
return false;
}
...
bool IsAtLeast(mpt::osinfo::windows::Version::System version, mpt::osinfo::windows::Version::ServicePack servicePack,
               mpt::osinfo::windows::Version::Build build) const
noexcept {
if(!m_SystemIsWindows) {
return false;
...
mpt::osinfo::windows::Version::System GetSystem() const
noexcept {
return m_System;
}
mpt::osinfo::windows::Version::ServicePack GetServicePack() const
noexcept {
return m_ServicePack;
}
mpt::osinfo::windows::Version::Build GetBuild() const
noexcept {
return m_Build;
}
mpt::osinfo::windows::Version::TypeId GetTypeId() const
noexcept {
return m_Type;
}
}; // class Version
...
version(uint8 vmajor_, uint8 vminor_, uint8 vupdate_)
        : valid(true), vmajor(vmajor_), vminor(vminor_), vupdate(vupdate_) {
return;
}
public:
bool IsValid() const {
