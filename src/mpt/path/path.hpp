...
static constexpr inline std_value_type
std_preferred_separator = std::filesystem::path::preferred_separator;
using os_value_type = os_path::value_type;
using os_string_type = os_path;
static constexpr inline os_value_type
os_preferred_separator = static_cast<os_value_type>(std::filesystem::path::preferred_separator);
private:
...
from_ospath(const os_path &s, std::filesystem::path::format fmt = std::filesystem::path::auto_format) {
