...
void ConvertBufferMixInternalFixedToBuffer(TOutBuf outBuf, TInBuf inBuf, Tdither &dither, std::size_t channels,
                                           std::size_t count) {
...
void ConvertBufferMixInternalToBuffer(TOutBuf outBuf, TInBuf inBuf, Tdither &dither, std::size_t channels,
                                      std::size_t count) {
using TOutSample = typename std::remove_const<typename TOutBuf::sample_type>::type;
using TInSample = typename std::remove_const<typename TInBuf::sample_type>::type;
assert(inBuf.size_channels() >= channels);
