...
noexcept;
public:
Version(mpt::osinfo::windows::Version v)
noexcept;
public:
Version(mpt::OS::Windows::Version::System system, mpt::OS::Windows::Version::ServicePack servicePack,
        mpt::OS::Windows::Version::Build build, mpt::OS::Windows::Version::TypeId type)
noexcept;
public:
static mpt::OS::Windows::Version Current()
noexcept;
public:
mpt::ustring GetName() const;
mpt::ustring GetNameShort() const;
public:
static mpt::OS::Windows::Version::System GetMinimumKernelLevel()
noexcept;
static mpt::OS::Windows::Version::System GetMinimumAPILevel()
noexcept;
}; // class Version
