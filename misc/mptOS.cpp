...
mpt::OS::Windows::Version Version::Current()
noexcept {
#if MPT_OS_WINDOWS
...
#else // !MPT_OS_WINDOWS
return
mpt::OS::Windows::Version::NoWindows();
#endif // MPT_OS_WINDOWS
}
Version::Version()
noexcept
...
Version Version::NoWindows()
noexcept {
return
Version();
}
Version::Version(mpt::osinfo::windows::Version v)
noexcept
:
mpt::osinfo::windows::Version(v)
        {
        }
Version::Version(mpt::OS::Windows::Version::System system, mpt::OS::Windows::Version::ServicePack servicePack,
                 mpt::OS::Windows::Version::Build build, mpt::OS::Windows::Version::TypeId type)
noexcept
:
...
mpt::OS::Windows::Version::System Version::GetMinimumKernelLevel()
noexcept
{
...
#endif
return
mpt::OS::Windows::Version::System(minimumKernelVersion);
}
mpt::OS::Windows::Version::System Version::GetMinimumAPILevel()
noexcept
{
#if MPT_OS_WINDOWS
...
VersionContext::VersionContext()
        : m_IsWine(false), m_HostClass(mpt::osinfo::osclass::Unknown) {
#if MPT_OS_WINDOWS
