...
static const struct bandInfoStruct bandInfo[9] =
        {
                ...
                },
                {
                        ...
                        {0, 4 * 3, 8 * 3, 12 * 3, 16 * 3, 22 * 3, 28 * 3, 38 * 3, 50 * 3, 64 * 3, 80 * 3,  100 *
                                                                                                           3,       126 *
                                                                                                                    3,   192 *
                                                                                                                         3},
                ...
                },
                {
                        ...
                        {0, 4 * 3, 8 * 3, 12 * 3, 16 * 3, 22 * 3, 30 * 3, 42 * 3, 58 * 3, 78 * 3, 104 * 3, 138 *
                                                                                                           3,       180 *
                                                                                                                    3,   192 *
                                                                                                                         3},
                ...
                { /* MPEG 2.0 */
                        ...
                        {0, 4 * 3, 8 * 3, 12 * 3, 18 * 3, 24 * 3, 32 * 3, 42 * 3, 56 * 3, 74 * 3, 100 * 3, 132 *
                                                                                                           3,       174 *
                                                                                                                    3,   192 *
                                                                                                                         3},
                ...
                { /* Twiddling 3 values here (not just 330->332!) fixed bug 1895025. */
                        ...
                        {0, 4 * 3, 8 * 3, 12 * 3, 18 * 3, 26 * 3, 36 * 3, 48 * 3, 62 * 3, 80 * 3, 104 * 3, 136 *
                                                                                                           3,       180 *
                                                                                                                    3,   192 *
                                                                                                                         3},
                ...
                },
                {
                        {0, 6,  12, 18, 24, 30, 36, 44, 54,  66,  80,  96,  116, 140, 168, 200, 238, 284, 336, 396, 464, 522, 576},
                        {6,  6,  6,  6,  6,  6,  8,  10, 12, 14, 16, 20, 24, 28, 32, 38, 46, 52, 60, 68, 58,  54},
                        {0, 4 * 3, 8 * 3, 12 * 3, 18 * 3, 26 * 3, 36 * 3, 48 * 3, 62 * 3, 80 * 3, 104 * 3, 134 *
                                                                                                           3,       174 *
                                                                                                                    3,   192 *
                                                                                                                         3},
