...
constexpr std::tuple<unsigned long long, unsigned long long, unsigned long long>
as_tuple() const
noexcept {
return std::make_tuple(Major, Minor, Patch);
}
};
constexpr bool operator==(SemanticVersion a, SemanticVersion b)
noexcept {
return a.
as_tuple()
== b.
...
constexpr std::tuple<std::tuple < unsigned long long, unsigned long long, unsigned long long>,
unsigned long long>
as_tuple() const
noexcept {
...
constexpr bool operator==(VersionInfo a, VersionInfo b)
noexcept {
return a.
as_tuple()
== b.
...
Version = {{ASIO_VERSION_MAJOR, ASIO_VERSION_MINOR, ASIO_VERSION_PATCH}, ASIO_VERSION_BUILD};
constexpr inline VersionInfo
ModernSDKVersion = {{ASIO_MODERNSDK_VERSION_MAJOR, ASIO_MODERNSDK_VERSION_MINOR, ASIO_MODERNSDK_VERSION_PATCH},
