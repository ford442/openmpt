...
static constexpr internal_type
scale = static_cast<internal_type>(1) << 24;
};
template<>
...
using internal_type = std::int64_t;
static constexpr internal_type
scale = static_cast<internal_type>(1) << 16;
};
template<>
...
using internal_type = std::int64_t;
static constexpr internal_type
scale = static_cast<internal_type>(1) << 0;
};
template<>
...
static constexpr SampleType
sample_type = SampleType::Int16MSB;
using internal_type = std::int64_t;
...
static constexpr SampleType
sample_type = SampleType::Int24MSB;
using internal_type = std::int64_t;
...
static constexpr SampleType
sample_type = SampleType::Int32MSB;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32MSB16;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32MSB18;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32MSB20;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32MSB24;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Float32MSB;
using internal_type = float;
...
static constexpr SampleType
sample_type = SampleType::Float64MSB;
using internal_type = double;
...
static constexpr SampleType
sample_type = SampleType::Int32LSB16;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32LSB18;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32LSB20;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Int32LSB24;
using internal_type = std::int64_t;
using value_type = std::int32_t;
using unsigned_type = std::make_unsigned<value_type>::type;
static constexpr std::size_t
...
static constexpr SampleType
sample_type = SampleType::Float64LSB;
using internal_type = double;
using value_type = double;
using unsigned_type = double;
static constexpr std::size_t
...
template<>
constexpr double clip<double>(double dbl)
noexcept {
return
std::clamp(dbl,
-1.0, 1.0);
...
template<>
constexpr float clip<float>(float flt)
noexcept {
return
std::clamp(flt,
-1.0f, 1.0f);
...
inline Tdst convert_internal(Tsrc x)
noexcept = delete;
template<>
inline std::int64_t convert_internal<std::int64_t, std::int64_t>(std::int64_t q32)
noexcept {
return
q32;
}
template<>
inline std::int64_t convert_internal<std::int64_t, double>(double dbl)
noexcept {
return
std::llround(dbl
...
template<>
inline std::int64_t convert_internal<std::int64_t, float>(float flt)
noexcept {
return
std::llround(flt
* static_cast<float>(1ll << 32));
}
template<>
inline double convert_internal<double, std::int64_t>(std::int64_t q32)
noexcept {
return static_cast
<double>(q32)
* (1.0 / static_cast<double>(1ll << 32));
}
template<>
inline double convert_internal<double, double>(double dbl)
noexcept {
return
dbl;
}
template<>
inline double convert_internal<double, float>(float flt)
noexcept {
return static_cast
<double>(flt);
}
template<>
inline float convert_internal<float, std::int64_t>(std::int64_t q32)
noexcept {
return static_cast
<float>(q32)
* (1.0f / static_cast<float>(1ll << 32));
}
template<>
inline float convert_internal<float, double>(double dbl)
noexcept {
return static_cast
<float>(dbl);
}
template<>
inline float convert_internal<float, float>(float flt)
noexcept {
return
flt;
}
template<typename SampleType>
inline SampleType sample_from_value(typename Types<SampleType>::value_type val)
noexcept {
if
constexpr (Types<SampleType>::is_float) {
...
for (
std::size_t byte = 0;
byte < sizeof(SampleType); ++byte) {
if
constexpr (Types<SampleType>::is_be) {
        result.data[sizeof(SampleType) - 1 - byte] = std::byte{static_cast<std::uint8_t>(uval)};
}
else {
result.data[byte] = std::byte{ static_cast
<std::uint8_t>(uval)
};
}
uval /= (1u << 8);
...
template<typename SampleType>
inline typename Types<SampleType>::value_type value_from_sample(SampleType smp)
noexcept {
if
constexpr (Types<SampleType>::is_float) {
        static_assert(sizeof(SampleType) == sizeof(typename Types<SampleType>::value_type));
...
uval |=
std::to_integer<std::uint8_t>(smp
.data[sizeof(SampleType) - 1 - byte]);
}
}
return static_cast
<typename Types<SampleType>::value_type>(uval);
}
}
template<typename SampleType>
inline typename Types<SampleType>::value_type value_from_internal(typename Types<SampleType>::internal_type smp_int)
noexcept {
if
constexpr (Types<SampleType>::is_float) {
...
return static_cast
<typename Types<SampleType>::value_type> (clip(smp_int)
/ (static_cast<typename Types<SampleType>::internal_type>(1) << (32 - Types<SampleType>::valid_bits)));
}
}
template<typename SampleType>
inline typename Types<SampleType>::internal_type internal_from_value(typename Types<SampleType>::value_type val)
noexcept {
if
constexpr (Types<SampleType>::is_float) {
...
return clip(static_cast
<typename Types<SampleType>::internal_type>(val)
* (static_cast<typename Types<SampleType>::internal_type>(1) << (32 - Types<SampleType>::valid_bits)));
}
}
template<typename ExternalType>
inline typename TraitsExternal<ExternalType>::internal_type internal_from_external(ExternalType x)
noexcept {
static_assert(std::is_floating_point<typename TraitsExternal<ExternalType>::internal_type>::value
== std::is_floating_point<ExternalType>::value);
if
constexpr (std::is_floating_point<ExternalType>::value) {
        return static_cast<typename TraitsExternal<ExternalType>::internal_type>(x);
}
else {
return static_cast
<typename TraitsExternal<ExternalType>::internal_type>(x)
*
TraitsExternal<ExternalType>::scale;
}
}
template<typename ExternalType>
inline ExternalType external_from_internal(typename TraitsExternal<ExternalType>::internal_type x)
noexcept {
static_assert(std::is_floating_point<typename TraitsExternal<ExternalType>::internal_type>::value
== std::is_floating_point<ExternalType>::value);
if
...
inline SampleType sample_from_external(ExternalType x)
noexcept {
return
sample_from_value<SampleType>(value_from_internal<SampleType>(
        convert_internal<typename Types<SampleType>::internal_type, typename TraitsExternal<ExternalType>::internal_type>(
                internal_from_external<ExternalType>(x)))
);
}
template<typename ExternalType, typename SampleType>
inline ExternalType external_from_sample(SampleType x)
noexcept {
return
external_from_internal<ExternalType>(convert_internal<typename TraitsExternal<ExternalType>::internal_type, typename Types<SampleType>::internal_type>(
        internal_from_value<SampleType>(value_from_sample<SampleType>(x)))
);
}
template<typename Tdst>
inline void ClearBuffer(Tdst *dst, std::size_t dst_stride, std::size_t count)
noexcept {
for (
std::size_t i = 0;
i<count;
...
inline void
ConvertBuffer(Tdst *dst, std::size_t dst_stride, const Tsrc *src, std::size_t src_stride, std::size_t count, Tfunc func)
noexcept (noexcept(func(Tsrc()))) {
...
inline void ClearBufferASIO(void *dst, SampleType type, std::size_t count)
noexcept {
switch (type) {
...
template<typename Tdst>
inline void CopyRawFromASIO(Tdst *dst, std::size_t dst_stride, const void *src, std::size_t count)
noexcept {
detail::ConvertBuffer(dst, dst_stride,
static_cast
<const Tdst *>(src),
1, count, [](
Tdst smp
...
inline void CopyRawToASIO(void *dst, const Tsrc *src, std::size_t src_stride, std::size_t count)
noexcept {
detail::ConvertBuffer(static_cast<Tsrc *>(dst), 1, src, src_stride, count, [](
Tsrc smp
) { return
smp;
});
...
template<typename Tdst>
inline void ConvertFromASIO(Tdst *dst, std::size_t dst_stride, SampleType type, const void *src, std::size_t count)
noexcept {
switch (type) {
case SampleType::Int16MSB:
{
...
detail::external_from_sample<Tdst, SampleType>(smp);
});
}
break;
case SampleType::Int16LSB:
...
template<typename Tsrc>
inline void ConvertToASIO(void *dst, SampleType type, const Tsrc *src, std::size_t src_stride, std::size_t count)
noexcept {
switch (type) {
case SampleType::Int16MSB:
{
using SampleType = detail::Int16MSB;
detail::ConvertBuffer(static_cast<SampleType *>(dst), 1, src, src_stride, count, [](
Tsrc smp
) { return
detail::sample_from_external<SampleType, Tsrc>(smp);
});
}
break;
case SampleType::Int16LSB:
...
bool is_float = false;
bool is_be = false;
constexpr explicit Traits(SampleType type)
noexcept {
switch (type) {
case SampleType::Int16MSB: {
