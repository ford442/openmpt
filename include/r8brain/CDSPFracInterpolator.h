...
CDSPFracDelayFilterBank(const int aFilterFracs, const int aElementSize,
        ...
        : InitFilterFracs(aFilterFracs), ElementSize(aElementSize), InterpPoints(aInterpPoints), ReqAtten(aReqAtten),
          IsThird(aIsThird), Next(NULL), RefCount(1) {
...
CDSPFracInterpolator(const double aSrcSampleRate,
        ...
        : SrcSampleRate(aSrcSampleRate), DstSampleRate(aDstSampleRate)
#if R8B_FASTTIMING
