...
/* MPEG 1.0 */
        {{0, 4,  8,  12, 16, 20, 24, 30, 36,  44,  52,  62,  74,  90,  110, 134, 162, 196, 238, 288, 342, 418, 576},
                ...
                {0, 4 * 3, 8 * 3, 12 * 3, 16 * 3, 22 * 3, 30 * 3, 40 * 3, 52 * 3, 66 * 3, 84 * 3,  106 * 3, 136 * 3,
                                                                                                                     192 *
                                                                                                                     3},
                {4, 4, 4, 4,  6,  8,  10, 12, 14, 18, 22, 30, 56}},
        {{0, 4,  8,  12, 16, 20, 24, 30, 36,  42,  50,  60,  72,  88,  106, 128, 156, 190, 230, 276, 330, 384, 576},
                {4,  4,  4,  4,  4,  4,  6,  6,  6,  8,  10, 12, 16, 18, 22, 28, 34, 40, 46, 54, 54,  192},
                {0, 4 * 3, 8 * 3, 12 * 3, 16 * 3, 22 * 3, 28 * 3, 38 * 3, 50 * 3, 64 * 3, 80 * 3,  100 * 3, 126 *
                                                                                                            3,       192 *
                                                                                                                     3},
                {4, 4, 4, 4,  6,  6,  10, 12, 14, 16, 20, 26, 66}},
        {{0, 4,  8,  12, 16, 20, 24, 30, 36,  44,  54,  66,  82,  102, 126, 156, 194, 240, 296, 364, 448, 550, 576},
                {4,  4,  4,  4,  4,  4,  6,  6,  8,  10, 12, 16, 20, 24, 30, 38, 46, 56, 68, 84, 102, 26},
                {0, 4 * 3, 8 * 3, 12 * 3, 16 * 3, 22 * 3, 30 * 3, 42 * 3, 58 * 3, 78 * 3, 104 * 3, 138 * 3, 180 *
                                                                                                            3,       192 *
                                                                                                                     3},
...
/* MPEG 2.0 */
        {{0, 6,  12, 18, 24, 30, 36, 44, 54,  66,  80,  96,  116, 140, 168, 200, 238, 284, 336, 396, 464, 522, 576},
                ...
                {0, 4 * 3, 8 * 3, 12 * 3, 18 * 3, 24 * 3, 32 * 3, 42 * 3, 56 * 3, 74 * 3, 100 * 3, 132 * 3, 174 *
                                                                                                            3,       192 *
                                                                                                                     3},
        ...
        {{0, 6,  12, 18, 24, 30, 36, 44, 54,  66,  80,  96,  114, 136, 162, 194, 232, 278, 332, 394, 464, 540, 576},
                ...
                {0, 4 * 3, 8 * 3, 12 * 3, 18 * 3, 26 * 3, 36 * 3, 48 * 3, 62 * 3, 80 * 3, 104 * 3, 136 * 3, 180 *
                                                                                                            3,       192 *
                                                                                                                     3},
                {4, 4, 4, 6,  8,  10, 12, 14, 18, 24, 32, 44, 12}},
        {{0, 6,  12, 18, 24, 30, 36, 44, 54,  66,  80,  96,  116, 140, 168, 200, 238, 284, 336, 396, 464, 522, 576},
                {6,  6,  6,  6,  6,  6,  8,  10, 12, 14, 16, 20, 24, 28, 32, 38, 46, 52, 60, 68, 58,  54},
                {0, 4 * 3, 8 * 3, 12 * 3, 18 * 3, 26 * 3, 36 * 3, 48 * 3, 62 * 3, 80 * 3, 104 * 3, 134 * 3, 174 *
                                                                                                            3,       192 *
                                                                                                                     3},
...
/* well, there was a bug report, where this happened!
        ...
        */
lame_report_fnc
        (mp->report_err, "hip: OOPS, part2remain=%d l3=%d cb=%d bv=%d region1=%d region2=%d b-type=%d mixed=%d\n",
         part2remain, bobug_l3, bobug_sb, gr_infos->big_values, gr_infos->region1start, gr_infos->region2start,
         gr_infos->block_type, gr_infos->mixed_block_flag
        );
}
if(isbug) {
...
lame_report_fnc
        (mp->report_err, "hip: OOPS, 'gainpow2' buffer overflow  lsf=%d i-stereo=%d b-type=%d mixed=%d\n", mp->fr.lsf,
         i_stereo, gr_infos->block_type, gr_infos->mixed_block_flag
        );
}
