...
typedef interface IAudioTreble
IAudioTreble;
...
typedef interface IAudioAutoGainControl
...
typedef interface IAudioPeakMeter
IAudioPeakMeter;
...
typedef interface IDeviceSpecificProperty
...
typedef interface IControlChangeNotify
...
typedef interface IDeviceTopology
IDeviceTopology;
