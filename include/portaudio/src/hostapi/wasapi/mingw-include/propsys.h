...
typedef interface IInitializeWithFile
IInitializeWithFile;
...
typedef interface IObjectWithPropertyKey
...
typedef interface IPropertyChange
IPropertyChange;
...
typedef interface IPropertyChangeArray
...
typedef interface IPropertyStoreCapabilities
...
typedef interface IPropertyStoreCache
IPropertyStoreCache;
...
typedef interface IPropertyEnumType
IPropertyEnumType;
...
typedef interface IPropertyEnumTypeList
...
typedef interface IPropertyDescription
...
typedef interface IPropertyDescriptionAliasInfo
...
typedef interface IPropertyDescriptionSearchInfo
...
typedef interface IPropertySystem
IPropertySystem;
...
typedef interface IDelayedPropertyStoreFactory
...
typedef interface IPersistSerializedPropStorage
...
typedef interface IPropertySystemChangeNotify
...
typedef interface ICreateObject
ICreateObject;
...
IInitializeWithStream_RemoteInitialize_Proxy(
        IInitializeWithStream
* This,
/* [in] */ __RPC__in_opt IStream
*pstream,
/* [in] */ DWORD grfMode
);
void __RPC_STUB
IInitializeWithStream_RemoteInitialize_Stub(
        IRpcStubBuffer
*This,
...
typedef /* [unique] */  __RPC_unique_pointer IPropertyStore
*
LPPROPERTYSTORE;
...
/* [in] */ UINT
iIndex,
/* [in] */ __RPC__in_opt IPropertyChange
*ppropChange);
HRESULT ( STDMETHODCALLTYPE
*Append )(
IPropertyChangeArray *This,
...
*GetCanonicalName )(
IPropertyDescription *This,
/* [string][out] */ __RPC__deref_out_opt_string
LPWSTR *ppszName
);
HRESULT ( STDMETHODCALLTYPE
*GetPropertyType )(
...
*GetTypeFlags )(
IPropertyDescription *This,
/* [in] */ PROPDESC_TYPE_FLAGS
mask,
/* [out] */ __RPC__out PROPDESC_TYPE_FLAGS
*ppdtFlags);
HRESULT ( STDMETHODCALLTYPE
*GetViewFlags )(
IPropertyDescription *This,
...
/* [in] */ BOOL
fDescending,
/* [string][out] */ __RPC__deref_out_opt_string LPWSTR
*ppszDescription);
HRESULT ( STDMETHODCALLTYPE
*GetAggregationType )(
IPropertyDescription *This,
...
/* [in] */ __RPC__in
REFIID riid,
/* [iid_is][out] */ __RPC__deref_out_opt
void **ppv
);
/* [local] */ HRESULT ( STDMETHODCALLTYPE
...
IPropertyDescription_RemoteCoerceToCanonicalValue_Proxy(
        IPropertyDescription
* This,
/* [in] */ __RPC__in REFPROPVARIANT
propvar,
/* [out] */ __RPC__out PROPVARIANT
*ppropvar);
void __RPC_STUB
IPropertyDescription_RemoteCoerceToCanonicalValue_Stub(
        IRpcStubBuffer
*This,
IRpcChannelBuffer *_pRpcChannelBuffer,
        PRPC_MESSAGE
...
flags,
/* [unique][in] */ __RPC__in_opt IUnknown
*pUnkFactory,
/* [in] */ __RPC__in REFIID
riid,
/* [iid_is][out] */ __RPC__deref_out_opt void **ppv
...
typedef SERIALIZEDPROPSTORAGE __unaligned
*
PUSERIALIZEDPROPSTORAGE;
typedef const SERIALIZEDPROPSTORAGE __unaligned
*
...
EXTERN_C const IID
IID_IPropertySystemChangeNotify;
#if defined(__cplusplus) && !defined(CINTERFACE)
...
__in_ecount_opt(cChanges) const
PROPERTYKEY *rgpropkey,
        __in_ecount_opt(cChanges) const
PKA_FLAGS *rgflags,
        __in_ecount_opt(cChanges) const
...
unsigned long __RPC_USER
LPSAFEARRAY_UserSize64(unsigned long *, unsigned long, LPSAFEARRAY *);
unsigned char *__RPC_USER
LPSAFEARRAY_UserMarshal64(unsigned long *, unsigned char *, LPSAFEARRAY *);
unsigned char *__RPC_USER
LPSAFEARRAY_UserUnmarshal64(unsigned long *, unsigned char *, LPSAFEARRAY *);
void __RPC_USER
LPSAFEARRAY_UserFree64(unsigned long *, LPSAFEARRAY *);
/* [local] */ HRESULT STDMETHODCALLTYPE
IInitializeWithStream_Initialize_Proxy(
        IInitializeWithStream
* This,
/* [in] */ IStream *pstream,
/* [in] */ DWORD
grfMode);
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IInitializeWithStream_Initialize_Stub(
        IInitializeWithStream
* This,
/* [in] */ __RPC__in_opt IStream
*pstream,
