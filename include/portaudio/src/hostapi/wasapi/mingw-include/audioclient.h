...
typedef interface IAudioClient
IAudioClient;
...
typedef interface IAudioStreamVolume
IAudioStreamVolume;
...
typedef interface IChannelAudioVolume
IChannelAudioVolume;
