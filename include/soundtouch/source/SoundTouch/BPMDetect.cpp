...
const double _LPF_coeffs[5] = {0.00996655391939, -0.01944529148401, 0.00996655391939, 1.96867605796247,
                               -0.96916387431724};
...
beatcorr_ringbuff[(beatcorr_ringbuffpos + offs) % windowLen] += (float) ((sum > 0) ? sum
