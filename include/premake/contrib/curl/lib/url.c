...
/*
     ...
     */
data->set.maxconnects = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.reuse_forbid = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.reuse_fresh = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.verbose = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_HEADER:
/*
     ...
     */
data->set.include_header = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.hide_progress = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
...
/*
     ...
     */
data->set.opt_no_body = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     * return error.
     */
data->set.http_fail_on_error = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_KEEP_SENDING_ON_ERROR:
data->set.http_keep_sending_on_error = (0 != va_arg(param,
long)) ?
TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.upload = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
if(data->set.upload) {
...
/*
     ...
     */
data->set.get_filetime = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.server_response_timeout = va_arg(param,
long) *1000;
break;
...
/*
     ...
     * server.
     */
data->set.tftp_no_options = va_arg(param,
long) != 0;
break;
...
/*
     ...
     */
data->set.tftp_blksize = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.ftp_list_only = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_APPEND:
/*
     ...
     */
data->set.ftp_append = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.ftp_filemethod = (curl_ftpfile) va_arg(param,
long);
break;
case CURLOPT_NETRC:
/*
     ...
     */
data->set.use_netrc = (enum CURL_NETRC_OPTION) va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.prefer_ascii = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.timecondition = (curl_TimeCond) va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.timevalue = (time_t) va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.http_auto_referer = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
data->set.http_transfer_encoding = (0 != va_arg(param,
long)) ?
TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.http_follow_location = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.maxredirs = va_arg(param,
long);
break;
...
/*
     ...
     */
int postRedir = curlx_sltosi(va_arg(param,
long));
...
/*
     ...
     */
data->set.postfields = va_arg(param,
void *);
...
/*
     ...
     */
data->set.httppost = va_arg(param,
...
/*
     ...
     */
data->set.proxyheaders = va_arg(param,
struct curl_slist *);
break;
...
/*
     ...
     */
data->set.http200aliases = va_arg(param,
struct curl_slist *);
break;
...
/*
     ...
     * anything else.
     */
data->set.cookiesession = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
int bitcheck;
bool authbits;
unsigned long auth = va_arg(param,
unsigned long);
...
/*
     ...
     */
data->set.expect_100_timeout = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.tunnel_thru_httpproxy = (0 != va_arg(param,
long)) ?
TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.proxyport = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.proxytype = (curl_proxytype) va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.writeheader = (void *) va_arg(param,
void *);
break;
...
/*
     ...
     * error string in.
     */
data->set.errorbuffer = va_arg(param,
char *);
break;
...
data->set.ftp_use_eprt = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_FTP_USE_EPSV:
data->set.ftp_use_epsv = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_FTP_USE_PRET:
data->set.ftp_use_pret = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_FTP_SSL_CCC:
data->set.ftp_ccc = (curl_ftpccc) va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.ftp_skip_ip = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     * to-be-uploaded file.
     */
data->set.filesize = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.low_speed_limit = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.low_speed_time = va_arg(param,
long);
break;
case CURLOPT_URL:
/*
...
/*
     ...
     */
data->set.use_port = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.connecttimeout = va_arg(param,
long) *1000L;
break;
...
/*
     ...
     */
data->set.accepttimeout = va_arg(param,
long);
break;
...
/*
     ...
     */
result = setstropt_userpwd(va_arg(param,
char *),
...
/*
     ...
     */
data->set.postquote = va_arg(param,
struct curl_slist *);
break;
...
/*
     ...
     */
data->set.prequote = va_arg(param,
struct curl_slist *);
break;
case CURLOPT_QUOTE:
/*
...
/*
     ...
     */
data->set.progress_client = va_arg(param,
void *);
break;
#ifndef CURL_DISABLE_PROXY
...
/*
     ...
     */
data->set.set_resume_from = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.debugdata = va_arg(param,
void *);
break;
case CURLOPT_STDERR:
/*
...
/*
     ...
     */
data->set.seek_client = va_arg(param,
void *);
break;
...
/*
     ...
     */
data->set.ioctl_client = va_arg(param,
void *);
break;
...
/*
     ...
     */
data->set.localport = curlx_sltous(va_arg(param,
long));
break;
...
/*
     ...
     */
data->set.localportrange = curlx_sltosi(va_arg(param,
long));
break;
...
/*
     ...
     */
data->set.gssapi_delegation = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.ssl.primary.verifypeer = (0 != va_arg(param,
long)) ?
TRUE :
FALSE;
break;
...
data->set.ssl.primary.verifystatus = (0 != va_arg(param,
long)) ?
TRUE :
FALSE;
break;
...
data->set.ssl.falsestart = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.telnet_options = va_arg(param,
struct curl_slist *);
break;
...
/*
     ...
     */
data->set.buffer_size = va_arg(param,
long);
...
/*
     ...
     */
data->set.no_signal = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_SHARE: {
...
/*
     ...
     */
data->set.private_data = va_arg(param,
void *);
break;
...
/*
     ...
     */
data->set.max_filesize = va_arg(param,
long);
break;
#ifdef USE_SSL
...
/*
     ...
     */
data->set.ftpsslauth = (curl_ftpauth) va_arg(param,
long);
break;
case CURLOPT_IPRESOLVE:
data->set.ipver = va_arg(param,
long);
break;
...
/*
     ...
     * algorithm
     */
data->set.tcp_nodelay = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
data->set.ignorecl = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.connect_only = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.sockopt_client = va_arg(param,
void *);
break;
...
/*
     * socket callback data pointer. Might be NULL.
     */
data->set.opensocket_client = va_arg(param,
void *);
break;
...
/*
     * socket callback data pointer. Might be NULL.
     */
data->set.closesocket_client = va_arg(param,
void *);
break;
case CURLOPT_SSL_SESSIONID_CACHE:
data->set.general_ssl.sessionid = (0 != va_arg(param,
long)) ?
TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.http_te_skip = (0 == va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.http_ce_skip = (0 == va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
     ...
     */
data->set.new_file_perms = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.new_directory_perms = va_arg(param,
long);
break;
...
/*
     ...
     */
data->set.scope_id = curlx_sltoui(va_arg(param,
long));
break;
...
data->set.allowed_protocols = va_arg(param,
long);
break;
...
data->set.redir_protocols = va_arg(param,
long);
break;
...
data->set.mail_rcpt = va_arg(param,
struct curl_slist *);
break;
case CURLOPT_SASL_IR:
/* Enable/disable SASL initial response */
data->set.sasl_ir = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
/*
       ...
       */
long curl_rtspreq = va_arg(param,
long);
...
/*
     ...
     */
data->state.rtsp_next_client_CSeq = va_arg(param,
long);
break;
...
data->set.wildcardmatch = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
data->wildcard.customptr = va_arg(param,
void *);
break;
case CURLOPT_FNMATCH_DATA:
data->set.fnmatch_data = va_arg(param,
void *);
break;
#ifdef USE_TLS_SRP
...
result = Curl_set_dns_servers(data, va_arg(param,
char *));
break;
case CURLOPT_DNS_INTERFACE:
result = Curl_set_dns_interface(data, va_arg(param,
char *));
break;
case CURLOPT_DNS_LOCAL_IP4:
result = Curl_set_dns_local_ip4(data, va_arg(param,
char *));
break;
case CURLOPT_DNS_LOCAL_IP6:
result = Curl_set_dns_local_ip6(data, va_arg(param,
char *));
break;
case CURLOPT_TCP_KEEPALIVE:
data->set.tcp_keepalive = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_TCP_KEEPIDLE:
data->set.tcp_keepidle = va_arg(param,
long);
break;
case CURLOPT_TCP_KEEPINTVL:
data->set.tcp_keepintvl = va_arg(param,
long);
break;
...
data->set.ssl_enable_npn = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_SSL_ENABLE_ALPN:
data->set.ssl_enable_alpn = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
data->set.path_as_is = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
case CURLOPT_PIPEWAIT:
data->set.pipewait = (0 != va_arg(param,
long)) ? TRUE :
FALSE;
break;
...
data->set.connect_to = va_arg(param,
struct curl_slist *);
break;
default:
...
if((('a' <= data->change.url[0] && data->change.url[0] <= 'z') ||
   ...
   strcasecompare(data->set.str[STRING_DEFAULT_PROTOCOL], "file")) { ; /* do nothing */
...
else if(checkprefix("http:", proxy)); /* leave it as HTTP or HTTP/1.0 */
else {
