...
bool StoneCrackerDecompressor::detectHeaderAndGeneration(uint32_t
hdr,
uint32_t &generation
) noexcept {
...
bool StoneCrackerDecompressor::detectHeader(uint32_t
hdr) noexcept
{
uint32_t dummy;
return
detectHeaderAndGeneration(hdr, dummy
);
}
std::unique_ptr <Decompressor>
StoneCrackerDecompressor::create(const Buffer &packedData, bool exactSizeKnown, bool verify) {
...
const std::string &StoneCrackerDecompressor::getName() const
noexcept
{
switch (_generation)
{
...
size_t StoneCrackerDecompressor::getPackedSize() const
noexcept
{
return
_packedSize;
}
size_t StoneCrackerDecompressor::getRawSize() const
noexcept
{
return
_rawSize;
