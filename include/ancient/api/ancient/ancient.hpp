...
static bool detect(const std::vector <uint8_t> &packedData)
noexcept;
static bool detect(const uint8_t *packedData, size_t packedSize)
noexcept;
// Main entrypoint
...
static size_t getMaxPackedSize()
noexcept;
static size_t getMaxRawSize()
noexcept;
...
std::optional <size_t> getPackedSize() const
noexcept;
std::optional <size_t> getRawSize() const
noexcept;
...
std::optional <size_t> getImageSize() const
noexcept;
std::optional <size_t> getImageOffset() const
noexcept;
