...
static void X86_StereoDCRemoval(int *, uint32 count, int32 &nDCRFlt_Y1l, int32 &nDCRFlt_X1l, int32 &nDCRFlt_Y1r,
                                int32 &nDCRFlt_X1r);
...
{
if(nChannels > 2) ProcessQuadSurround(MixSoundBuffer, MixRearBuffer, count);
else
...
#define DCR_AMOUNT        9
static void
X86_StereoDCRemoval(int *pBuffer, uint32 nSamples, int32 &nDCRFlt_Y1l, int32 &nDCRFlt_X1l, int32 &nDCRFlt_Y1r,
                    int32 &nDCRFlt_X1r) {
